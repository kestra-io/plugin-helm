    ...
    examples = {
        @io.kestra.core.models.annotations.Example(
            ...
            code = """
                ...
                tasks:
                  - id: reverse
                    type: io.kestra.plugin.helm.HelmTask
                    format: "Text to be reverted"
                """
        )
    }
)
public class HelmTask extends Task implements RunnableTask<HelmTask.Output> {
    @Schema(
    ...
    @Override
    public HelmTask.Output run(RunContext runContext) throws Exception {
